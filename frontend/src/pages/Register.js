...
const Register = () => {
    ...
    const { username, name, email, password, dateofbirth, gender, mobilenumber, emergencyfullname, emergencynumber } = formData;
    ...
    const onSubmit = async (e) => {
        ...
        const requiredFields = ['username', 'name', 'email', 'password', 'dateofbirth', 'gender', 'mobilenumber', 'emergencyfullname', 'emergencynumber'];
        ...
        <>
            ...
            <section className="form">
                <form onSubmit={onSubmit}>
                    ...
                    <div className="form-group">
                        <label htmlFor="emergencyfullname">Emergency Contact Name:</label>
                        <input
                            type="text"
                            className="form-control"
